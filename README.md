...
- 판매자가 등록한 쇼핑몰 리스트를 출력합니다.
- 판매자에게 삭제할 쇼핑몰의 번호를 입력받습니다.
- 선택한 쇼핑몰 이름을 출력하고 해당 쇼핑몰을 삭제할지 재확인합니다.
- YES를 입력한 경우:
